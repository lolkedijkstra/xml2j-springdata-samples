package com.xml2j.sepa2016.pain.pain002.application;
...
import com.xml2j.sepa2016.pain.pain002.processor.CustomerPaymentStatusReportV07Processor;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			ParserTask app = new CustomerPaymentStatusReportV07Runnable(configuration);
			...
			app.prepareStart(inputStream, new CustomerPaymentStatusReportV07Processor());
			app.processXML();
