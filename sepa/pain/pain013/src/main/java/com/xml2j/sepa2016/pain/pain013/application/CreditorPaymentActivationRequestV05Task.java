...
import com.xml2j.sepa2016.pain.pain013.handlers.CreditorPaymentActivationRequestV05MessageHandler;
 ...
 */
public class CreditorPaymentActivationRequestV05Task extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public CreditorPaymentActivationRequestV05Task(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CreditorPaymentActivationRequestV05Task(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
