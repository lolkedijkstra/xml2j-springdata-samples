...
public class PaymentTypeInformation25 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	PaymentTypeInformation25 t = (PaymentTypeInformation25)that;
	 
		if (!Compare.equals(m_instrPrty, t.m_instrPrty))
			return false;
		
		if (!Compare.equals(m_clrChanl, t.m_clrChanl))
			return false;
	 ...
	 *  This method prints an XML fragment starting from PaymentTypeInformation25.
	 *
