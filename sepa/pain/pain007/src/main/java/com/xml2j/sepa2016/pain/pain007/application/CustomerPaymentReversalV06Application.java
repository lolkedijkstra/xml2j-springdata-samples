...
import com.xml2j.sepa2016.pain.pain007.processor.CustomerPaymentReversalV06Processor;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			ParserTask app = new CustomerPaymentReversalV06Task(configuration);
			...
			app.prepareStart(inputStream, new CustomerPaymentReversalV06Processor());
			app.processXML();
