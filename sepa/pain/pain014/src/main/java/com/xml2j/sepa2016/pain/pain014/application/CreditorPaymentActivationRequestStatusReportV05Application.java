...
import com.xml2j.sepa2016.pain.pain014.processor.CreditorPaymentActivationRequestStatusReportV05Processor;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			ParserTask app = new CreditorPaymentActivationRequestStatusReportV05Task(configuration);
			...
			app.prepareStart(inputStream, new CreditorPaymentActivationRequestStatusReportV05Processor());
			app.processXML();
