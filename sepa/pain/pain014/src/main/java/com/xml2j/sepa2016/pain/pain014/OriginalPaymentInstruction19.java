...
public class OriginalPaymentInstruction19 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	OriginalPaymentInstruction19 t = (OriginalPaymentInstruction19)that;
	 ...
	 *  This method prints an XML fragment starting from OriginalPaymentInstruction19.
	 *
	...
	protected void printElements(Printer out) {
		...
		if (m_txInfAndStsList != null) {
			for(PaymentTransaction69 l_TxInfAndSts : m_txInfAndStsList) {
