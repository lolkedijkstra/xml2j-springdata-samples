...
import com.xml2j.sepa2016.pain.pain001.processor.CustomerCreditTransferInitiationV07Processor;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			ParserTask app = new CustomerCreditTransferInitiationV07Task(configuration);
			...
			app.prepareStart(inputStream, new CustomerCreditTransferInitiationV07Processor());
			app.processXML();
