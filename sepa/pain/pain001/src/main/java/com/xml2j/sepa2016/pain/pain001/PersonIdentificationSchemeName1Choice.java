...
public class PersonIdentificationSchemeName1Choice extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	PersonIdentificationSchemeName1Choice t = (PersonIdentificationSchemeName1Choice)that;
	 ...
	 *  This method prints an XML fragment starting from PersonIdentificationSchemeName1Choice.
	 *
