...
import com.xml2j.sepa2016.pain.pain008.processor.CustomerDirectDebitInitiationV06Processor;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			ParserTask app = new CustomerDirectDebitInitiationV06Task(configuration);
			...
			app.prepareStart(inputStream, new CustomerDirectDebitInitiationV06Processor());
			app.processXML();
