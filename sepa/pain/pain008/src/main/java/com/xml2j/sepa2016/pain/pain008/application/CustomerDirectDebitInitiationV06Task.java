package com.xml2j.sepa2016.pain.pain008.application;
...
import com.xml2j.sepa2016.pain.pain008.handlers.CustomerDirectDebitInitiationV06MessageHandler;
 ...
 */
public class CustomerDirectDebitInitiationV06Task extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public CustomerDirectDebitInitiationV06Task(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CustomerDirectDebitInitiationV06Task(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
