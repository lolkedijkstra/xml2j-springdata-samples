...
public class TaxInformation3 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	TaxInformation3 t = (TaxInformation3)that;
		...
		if (!Compare.equals(m_admstnZn, t.m_admstnZn))
			return false;
	 ...
	 *  This method prints an XML fragment starting from TaxInformation3.
	 *
